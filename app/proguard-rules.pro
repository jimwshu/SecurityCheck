...
# in /Users/wangshu/Library/Android/sdk/tools/proguard/proguard-android.txt
...
-keep class qsbk.app.ppduobao.push.XiaoMiPushReceiver {*;}
#可以防止一个误报的 warning 导致无法成功编译，如果编译使用的 Android 版本是 23。
-dontwarn com.xiaomi.push.**
#ali 把所有的jar包申明进来，compile里已经申明了
