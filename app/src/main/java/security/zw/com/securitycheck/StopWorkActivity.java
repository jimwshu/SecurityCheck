...
public class StopWorkActivity extends BaseSystemBarTintActivity implements MyProjectView {
    ...
    public static void launch(Context ctx) {
        Intent intent = new Intent(ctx, StopWorkActivity.class);
    ...
    */
    ...
    protected StopWorkAdapter mAdapter;
    ...
    private void initWidget() {
        ...
        mAdapter = new StopWorkAdapter(data, this);
        mAdapter.setOnClick(new StopWorkAdapter.onClick() {
            @Override
            public void onClick(int pos) {
                ProjectInfo p = data.get(pos);
                StopWorkChangeActivity.launch(StopWorkActivity.this, p);
            }
        });
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayoutBoth.OnRefreshListener() {
            ...
            public void onRefresh(SwipeRefreshLayoutBoth.SwipeRefreshLayoutDirection direction) {
                if (direction == SwipeRefreshLayoutBoth.SwipeRefreshLayoutDirection.TOP) {
                    StopWorkActivity.this.onRefresh();
    ...
    private void loadData() {
        ...
        isLoading = true;
        presenter.getProjectList(type, page, "", -1);
