...
public class EquipmentDetailActivity extends BaseSystemBarTintActivity {
    ...
    public static void launch(Context ctx, EquipmentList p) {
        Intent intent = new Intent(ctx, EquipmentDetailActivity.class);
    ...
    protected EquipmentDetailAdapter mAdapter;
    ...
    private void initView() {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                EquipmentDetailActivity.this.onRefresh();
            }
        });
