...
public class PersonActivity extends BaseSystemBarTintActivity {
    ...
    */
    ...
    private void initWidget() {
        ...
        mAdapter = new PersonAdapter(data, this, 1);
    ...
    private void loadData() {
        ...
        mCall = addCheck.getPersonList(requestBody);
                            ...
                            if (code == 0) {
                                ...
                                if (object != null && object.length() > 0) {
                                    for (int i = 0; i < object.length(); i++) {
                                        ...
                                        Person company = new Gson().fromJson(object1.toString(), Person.class);
