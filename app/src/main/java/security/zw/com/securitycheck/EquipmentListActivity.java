...
// 整改列表（相对于项目）
public class EquipmentListActivity extends BaseSystemBarTintActivity {


    public static void launch(Context ctx, int type) {
        Intent intent = new Intent(ctx, EquipmentListActivity.class);
    ...
    protected EquipmentListAdapter mAdapter;
    ...
    private void initWidget() {
        ...
        mAdapter = new EquipmentListAdapter(data, this);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                EquipmentListActivity.this.onRefresh();
            }
        });
    }
