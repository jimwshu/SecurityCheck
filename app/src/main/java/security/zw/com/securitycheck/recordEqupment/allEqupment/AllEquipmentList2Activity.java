...
// 整改列表（相对于项目）
public class AllEquipmentList2Activity extends BaseSystemBarTintActivity {


    public static void launch(Context ctx, int type, EquipmentList p) {
        Intent intent = new Intent(ctx, AllEquipmentList2Activity.class);
        intent.putExtra("equipment", p);
    ...
    protected AllEquipmentList2Adapter mAdapter;
    ...
    private void initWidget() {
        ...
        info = (EquipmentList) getIntent().getSerializableExtra("equipment");
        if (info == null) {
            finish();
        }
        ...
        mAdapter = new AllEquipmentList2Adapter(data, this);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                AllEquipmentList2Activity.this.onRefresh();
            }
        });
    }
    ...
    private void loadData() {
        ...
        mCall = addCheck.usedInProjects(requestBody);
