package security.zw.com.securitycheck.uninstallEqupment.allEqupment.allEqupment;
...
public class InstallEquipmentDetailActivity extends BaseSystemBarTintActivity {
    ...
    private void loadData() {
        ...
        mCall = addCheck.getEquipmentUninstallDoc(requestBody);
    ...
    private void setYseOrNo(boolean yes) {
        ...
        mCall = addCheck.getEquipmentUninstallDocAudit(requestBody);
