...
public class AllEquipmentDetailAdapter extends RecyclerView.Adapter<AllEquipmentDetailAdapter.ProjectViewHolder> {
    ...
    public AllEquipmentDetailAdapter(ArrayList<EquipmentDetail> mData, Activity mActivity) {
        this.mData = mData;
        this.mContext = mActivity;
    }

    public AllEquipmentDetailAdapter(ArrayList<EquipmentDetail> mData, Activity mActivity, int type) {
        this.mData = mData;
        this.mContext = mActivity;
        this.type = type;
    }
    ...
    @Override
    public AllEquipmentDetailAdapter.ProjectViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AllEquipmentDetailAdapter.ProjectViewHolder holder, final int position) {
