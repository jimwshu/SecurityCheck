...
package security.zw.com.securitycheck.widget.refresh;
...
public class SwipeRefreshLayoutBoth extends ViewGroup {
    ...
    private static final String LOG_TAG = SwipeRefreshLayoutBoth.class.getSimpleName();
     ...
     * @param attrs
     */
    public SwipeRefreshLayoutBoth(Context context, AttributeSet attrs) {
        super(context, attrs);
