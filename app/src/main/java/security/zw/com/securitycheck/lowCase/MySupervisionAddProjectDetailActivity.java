...
public class MySupervisionAddProjectDetailActivity extends BaseSystemBarTintActivity {




    public static void launch(Context ctx, ProjectInfo p) {
        Intent intent = new Intent(ctx, MySupervisionAddProjectDetailActivity.class);
    ...
    */
    ...
    private RelativeLayout area;//立案单位电话
    ...
    private RelativeLayout cost;//立案单位地址
    ...
    private RelativeLayout state;//法定负责人
    ...
    private RelativeLayout image;//法定负责人电话
    ...
    private RelativeLayout district;//法定负责人职务
    private TextView district_title;
    private TextView district_state;
    private ImageView bar_next_8;
    private ImageView map_8;

    private RelativeLayout description;//法定负责人职务
    private TextView description_title;
    private TextView description_state;
    private ImageView bar_next_12;
    private ImageView map_12;

    private RelativeLayout publishment;//法定负责人职务
    private TextView publishment_title;
    private TextView publishment_state;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_low_case_detail);
    ...
    private void initView() {
        ...
        construct_title.setText("立案单位名称");
        ...
        district_title.setText("法定负责人职务");
        ...
        description_title = description.findViewById(R.id.title);
        description_state = description.findViewById(R.id.state);
        description_title.setText("案情");

        bar_next_12 = description.findViewById(R.id.bar_next);
        map_12 = description.findViewById(R.id.map);
        bar_next_12.setVisibility(View.GONE);
        map_12.setVisibility(View.GONE);


        publishment = findViewById(R.id.publishment);
        publishment_title = publishment.findViewById(R.id.title);
        publishment_state = publishment.findViewById(R.id.state);
        publishment_title.setText("案情");

        bar_next_13 = publishment.findViewById(R.id.bar_next);
        map_13 = publishment.findViewById(R.id.map);
    ...
    private ArrayList<ImageInfo> imagePaths1 = new ArrayList<>();
    private SimpleDraweeView[] addImageViews1 = new SimpleDraweeView[3];
    private View[] imageDeleteBtns1 = new View[3];


    private void resetImageViews1() {

        int imageCount = imagePaths1.size();
        for (int i = 0; i < imageCount; i++) {
            FrescoImageloader.displayImage(addImageViews1[i], imagePaths1.get(i).getImageUrl());
            addImageViews1[i].setVisibility(View.VISIBLE);
            imageDeleteBtns1[i].setVisibility(View.VISIBLE);
        }

        if (imageCount < addImageViews1.length) {
            FrescoImageloader.displayImage(addImageViews1[imageCount], "", R.mipmap.image_add);
            addImageViews1[imageCount].setVisibility(View.VISIBLE);
            imageDeleteBtns1[imageCount].setVisibility(View.GONE);
        }
        for (int i = imageCount + 1; i < addImageViews1.length; i++) {
            addImageViews1[i].setVisibility(View.GONE);
            imageDeleteBtns1[i].setVisibility(View.GONE);
        }
    }

    private void deleteImage1(int pos) {
        imagePaths1.remove(pos);
        resetImageViews1();
    }

    private void startMediaPicker1() {
        Intent intent = ImagesPickerActivity.prepareIntent(this, 3 - imagePaths1.size());
        startActivityForResult(intent, 700);
    }

    private ArrayList<ImageInfo> imagePaths2 = new ArrayList<>();
    private SimpleDraweeView[] addImageViews2 = new SimpleDraweeView[3];
    private View[] imageDeleteBtns2 = new View[3];


    private void resetImageViews2() {

        int imageCount = imagePaths2.size();
        for (int i = 0; i < imageCount; i++) {
            FrescoImageloader.displayImage(addImageViews2[i], imagePaths2.get(i).getImageUrl());
            addImageViews2[i].setVisibility(View.VISIBLE);
            imageDeleteBtns2[i].setVisibility(View.VISIBLE);
        }

        if (imageCount < addImageViews2.length) {
            FrescoImageloader.displayImage(addImageViews2[imageCount], "", R.mipmap.image_add);
            addImageViews2[imageCount].setVisibility(View.VISIBLE);
            imageDeleteBtns2[imageCount].setVisibility(View.GONE);
        }
        for (int i = imageCount + 1; i < addImageViews2.length; i++) {
            addImageViews2[i].setVisibility(View.GONE);
            imageDeleteBtns2[i].setVisibility(View.GONE);
        }
    }

    private void deleteImage2(int pos) {
        imagePaths2.remove(pos);
        resetImageViews2();
    }

    private void startMediaPicker2() {
        Intent intent = ImagesPickerActivity.prepareIntent(this, 3 - imagePaths2.size());
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (paths != null && paths.size() > 0) {
                    for (ImageInfo i : paths) {
                        if (new File(i.getFilePath(MySupervisionAddProjectDetailActivity.this)).exists()) {
                            imagePaths.add(i);
                        }
                    }
                }
