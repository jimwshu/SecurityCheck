...
public class ImagePipelineConfigUtils {
    ...
    public static ImagePipelineConfig getDefaultImagePipelineConfig(Context context) {
        ...
        //小图片的磁盘配置
        DiskCacheConfig diskSmallCacheConfig = DiskCacheConfig.newBuilder(context).setBaseDirectoryPath(SecurityApplication.getInstance().getExternalCacheDir())//缓存图片基路径
        ...
        //默认图片的磁盘配置
        DiskCacheConfig diskCacheConfig = DiskCacheConfig.newBuilder(context).setBaseDirectoryPath(SecurityApplication.getInstance().getExternalCacheDir())//缓存图片基路径
